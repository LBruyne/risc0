    ...
    C: CircuitCoreDef<F>,
{
        ...
        CheckCodeFn: Fn(u32, &Digest) -> Result<(), VerificationError>,
    {
        ...
        // println!("codeRoot = {}", code_merkle.root());
        ...
        // println!("dataRoot = {}", data_merkle.root());
        ...
        // println!("cur_mix: {cur_mix:?}, cur_pos: {cur_pos}");
        // Handle check group
        let mut check_mix_pows = Vec::with_capacity(Self::CHECK_SIZE);
        for _ in 0..Self::CHECK_SIZE {
