...
pub fn lift(segment_receipt: &SegmentReceipt) -> Result<SuccinctReceipt> {
    println!("Proving lift: claim = {:#?}", segment_receipt.claim);
    ...
    println!("Proving lift finished: decoded claim = {claim_decoded:#?}");
    Ok(SuccinctReceipt {
        seal: receipt.seal,
...
pub fn join(a: &SuccinctReceipt, b: &SuccinctReceipt) -> Result<SuccinctReceipt> {
    println!("Proving join: a.claim = {:#?}", a.claim);
    println!("Proving join: b.claim = {:#?}", b.claim);
    ...
    let claim_decoded = ReceiptClaim::decode(&mut out_stream)?;
    println!("Proving join finished: decoded claim = {claim_decoded:#?}");
    Ok(SuccinctReceipt {
        seal: receipt.seal,
        control_id: receipt.control_id,
...
pub fn resolve(
    ...
    let claim_decoded = ReceiptClaim::decode(&mut out_stream)?;
    println!("Proving resolve finished: decoded claim = {claim_decoded:#?}");
    Ok(SuccinctReceipt {
        seal: receipt.seal,
        control_id: receipt.control_id,
